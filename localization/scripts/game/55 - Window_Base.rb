...
class Window_Base < Window
  ...
  # ● 各種文字色の取得
  #--------------------------------------------------------------------------
  def normal_color;      if $game_switches[444] == false; text_color(0);else;text_color(18);end;   end;    # 通常
  def system_color;      if $game_switches[444] == false; text_color(16);else;text_color(18);end;  end;    # システム
  def crisis_color;      text_color(17);  end;    # ピンチ
  def knockout_color;    text_color(18);  end;    # 戦闘不能
  def gauge_back_color;  if $game_switches[444] == false; text_color(19);else;Color.new(20,0,0);end;  end;    # ゲージ背景
  def hp_gauge_color1;    Color.new(222, 0, 0); end;#text_color(20);  end;    # HP ゲージ 1
  def hp_gauge_color2;    Color.new(222, 0, 0); end;#text_color(21);  end;    # HP ゲージ 2
