...
module CUSTOM_GET_WINDOW
  DISPLAY_FLAG = 15
  GOLD_TEXT_ADD      = "Soul Obtained!"        #お金を入手した際の表示テキスト
  GOLD_TEXT_REMOVE   = "Soul Lost..."        #お金を消失した際の表示テキスト
  ITEM_TEXT_ADD      = "Item Obtained!"    #アイテムを入手した際の表示テキスト
  ITEM_TEXT_REMOVE   = "Item Lost..."    #アイテムを消失した際の表示テキスト
  WEAPON_TEXT_ADD    = "Weapon Obtained!"        #武器を入手した際の表示テキスト
  WEAPON_TEXT_REMOVE = "Weapon Lost..."        #武器を消失した際の表示テキスト
  ARMOR_TEXT_ADD     = "Armor Obtained!"        #防具を入手した際の表示テキスト
  ...
  EXP_TEXT_ADD       = "EXP Obtained!"         #EXPを入手した際の表示テキスト
...
class Window_Getinfo < Window_Base
  ...
  G_ICON  = 528   # ゴールド入手インフォに使用するアイコンインデックス 
  T_ICON  = 0   # テキスト表示インフォに使用するアイコンインデックス 
  ...
  INFO_SE = RPG::SE.new("Magic1"  , 80, 95) # インフォ表示時の効果音
...
class Window_Getinfo < Window_Base
  ...
  #--------------------------------------------------------------------------
  def dispose
    $game_temp.getinfo_size[@i] = nil if @i
    super
  end
  #--------------------------------------------------------------------------
  # ● フレーム更新
