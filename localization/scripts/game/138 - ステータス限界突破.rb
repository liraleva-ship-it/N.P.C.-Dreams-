#==============================================================================
# ■ RGSS3 限界突破＆限界変動特徴 Ver1.05　by 星潟
#------------------------------------------------------------------------------
...
class RPG::BaseItem
  ...
  def f_limit_param
    ...
    @f_limit_param ||= create_f_limit_param
    
  end
  def create_f_limit_param
...
class Game_BattlerBase
  ...
  def param_max(param_id)
    ...
    return LB::E[param_id] + limit_param(param_id) if param_id >= 0 && param_id <= 7
    super
  end
end
class Game_Actor < Game_Battler
  ...
  def param_max(param_id)
    ...
    return LB::A[param_id] + limit_param(param_id) if param_id >= 0 && param_id <= 7
    super
  end
end
if LB::PRDRW1 > 0
