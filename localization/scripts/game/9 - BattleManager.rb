...
module BattleManager
  ...
  def self.play_battle_bgm
    ...
    RPG::BGS.stop unless $game_switches[330] == true
  end
  #--------------------------------------------------------------------------
  # ● 戦闘終了 ME の演奏
  #--------------------------------------------------------------------------
  def self.play_battle_end_me
    $game_system.battle_end_me.play#こっこー
    if $game_switches[990] == true
      Audio.se_play("Audio/SE/Collapse3", 80, 100)
      $game_switches[990] = false
    end
  end
  #--------------------------------------------------------------------------
  # ● BGM と BGS の再開
  ...
  if $game_variables[287] == 0
    case $game_variables[29]
    when 0; $game_variables[287] = 1
    when 1; $game_variables[287] = 1.2
    when 2; $game_variables[287] = 1.5
    when 3; $game_variables[287] = 1.9
    when 4; $game_variables[287] = 2.4
    when 5; $game_variables[287] = 3
    when 6; $game_variables[287] = 3.7
    when 7; $game_variables[287] = 4.5
    when 8; $game_variables[287] = 10
    end
  end
    $game_variables[285] = 0 if ($game_variables[285] != 0)
  ...
  if $game_switches[988] == true
    $game_switches[15] = false
    $game_switches[988] = false #かしこしっ！
    $game_party.gain_item($data_items[60], -1)
