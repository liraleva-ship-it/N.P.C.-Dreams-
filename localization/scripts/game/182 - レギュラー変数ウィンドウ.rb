...
module W_REGULAR
  ...
  ITEM[0] = [
  {:icon_id => 96,:name => "",:afterword => " S",:variable_id => 7,:switch_id => 997,:x => 0,:y => 0,:width => 120,:name_c => 16},
  {:icon_id => 143,:name => "変数2",:afterword => " Q",:variable_id => 2,:switch_id => 1,:x => 0,:y => 24,:width => 120,:name_c => 16},
  {:icon_id => 125,:afterword => " Q",:variable_id => 3,:switch_id => 1,:x => 0,:y => 48,:width => 120,:name_c => 16}
  ]
  
  #VIDの変数IDに格納されている値が1の時
  
  ITEM[1] = [
  {:icon_id => 528,:name => "",:afterword => " S",:variable_id => 7,:switch_id => 997,:x => 0,:y => 0,:width => 130,:name_c => 16},
  {:icon_id => 144,:name => "変数5",:afterword => " Q",:variable_id => 5,:switch_id => 1,:x => 0,:y => 24,:width => 120,:name_c => 16},
  {:icon_id => 126,:afterword => " Q",:variable_id => 6,:switch_id => 1,:x => 0,:y => 48,:width => 120,:name_c => 16}
  ]
  
  #VIDの変数IDに格納されている値が2の時
  
  ITEM[2] = [
  {:icon_id => 0,:name => "",:afterword => " Q",:variable_id => 7,:switch_id => 997,:x => 0,:y => 0,:width => 130,:name_c => 16},
  {:icon_id => 144,:name => "変数5",:afterword => " Q",:variable_id => 5,:switch_id => 1,:x => 0,:y => 24,:width => 120,:name_c => 16},
  {:icon_id => 126,:afterword => " Q",:variable_id => 6,:switch_id => 1,:x => 0,:y => 48,:width => 120,:name_c => 16}
  ]
