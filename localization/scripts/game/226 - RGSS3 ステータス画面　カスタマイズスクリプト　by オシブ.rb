...
module Oxib_status
  ...
  #追加能力値、特殊能力値
  ACTOR_EXPARAMS = [false, false, true, false]
    EXPARAMS_POS = [200, 30]
  #装備
  ACTOR_EQUIP = [false, false, false, false]
    EQUIP_POS = [4, line_height * 1 + 8]
  #スキル
  ACTOR_SKILLS = [false, false, false, false]
  ...
  #キャラ説明
  ACTOR_DESCRIPTION = [true, true, true, true]
    DESCRIPTION_POS = [4, 400]
  ...
  ELEMENTS = {1=>131, 9=>112, 10=>103, 11=>140, 18=>538}
  # ステート耐性の表示対象となるステートID
  STATES_WORD = "Ailment RES"  
  STATES = [38,39]
...
class Window_Status < Window_Selectable
  ...
  def draw_element_resist(actor, x, y)
    ...
    for element_id in ELEMENTS.keys
      ...
      icon_x = x if turn_back?(icon_x, 34)
